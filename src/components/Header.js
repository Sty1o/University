            ...
            <div className="container">
              <div className="header-menu">
                <div className="row no-gutters align-items-center justify-content-center">
                  <div className="col-4 col-md-2"><a className="logo_swg" href="/"><img src= {logo} alt="logo" /></a></div>
                    ...
                    <div className="menu-function">
                      <div id="search"><a className="search-btn" href="blog_detail_sidebar.html#"><FontAwesomeIcon icon={faSearch} /></a></div>
                          <div className="social-contact">
                              {/*<a href="https://www.facebook.com/"><FontAwesomeIcon icon={faTelegram} /></a>
                              <a href="https://dribbble.com/"><FontAwesomeIcon icon={faFacebook} /></a>*/}
                              <a href="login"><FontAwesomeIcon icon={faUser} /></a>
                              <a href="register"><FontAwesomeIcon icon={faFingerprint} /></a>
                          </div>
                    </div>
                  </div>
                </div>
