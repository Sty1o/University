  ...
  return (
    <section className="posts blog-metro">
      <div className="container-fluid">
        <div className="metro-news_block">
                ...
                <div className="col-12 col-sm-6">
                  <div className="post-classic-tib"> <img src = {post5} alt="post" />
                    <div className="post-detail">
                      <div className="post-credit">
                        <div className="post-tag"><a href="index.html">tech</a></div>
                      </div><a className="post-title title" href="blog_detail.html">Photo awards of the year</a>
                      <div className="post-credit">
                        <div className="author">
                          <h5 className="author-name">Lucas Norman</h5>
                        </div>
                ...
                <div className="col-12 col-sm-6">
                  <div className="post-classic-tib"> <img src = {post9} alt="post" />
                    <div className="post-detail">
                      <div className="post-credit">
                        <div className="post-tag"><a href="index.html">tech</a></div>
                      </div><a className="post-title title" href="blog_detail.html">Vietnam's largest art community</a>
                      <div className="post-credit">
                        <div className="author">
                          <h5 className="author-name">Lucas Norman</h5>
                        </div>
